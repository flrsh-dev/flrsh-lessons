...
With the driver, you can create a DBI connection to the database specified by your driver. The `driver` in this case points to an in-memory DuckDB database. 
...
send queries directly to the database
